...
func TestNewValidatesWebSocketServerURL(t *testing.T) {
	valid := []string{"ws://127.0.0.1:8080/ws/client", "wss://speed.example.com/ws/client?region=cn"}
	...
	invalid := []string{"", "http://127.0.0.1:8080/ws/client", "ws:///ws/client", "ws://user:pass@example.com/ws"}
