...
In addition, `.github/workflows/docker-publish.yml` triggers on `v*` tag pushes or manual workflow dispatch to build and publish multi-mode Alpine Docker images to GitHub Container Registry (`ghcr.io/smagicalk/smalux-speedtest`).
